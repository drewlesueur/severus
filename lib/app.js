(function() {
  ...
  root.db.open(function() {
    app.post("/method/:method", function(req, res) {
    ...
    app.post("/:collection", function(req, res) {
      ...
      return methods.insert(args, req, res, alt);
    });
    ...
    return app.del("/:collection/:id", function(req, res) {
      var args;
      args = {
        _type: req.param("collection"),
        _id: req.param("id")
